...
| [azurerm_role_assignment.staging_app_ra](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
| [azurerm_role_assignment.transformer_output_app_ra](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
...
| <a name="input_queue_topic_connection_string"></a> [queue\_topic\_connection\_string](#input\_queue\_topic\_connection\_string) | The connection string to use for reading from the queue topic | `string` | n/a | yes |
...
The Terraform Azurerm Snowflake Loader on VMSS project is Copyright 2023-present Snowplow Analytics Ltd.
